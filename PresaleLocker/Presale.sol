...
contract Presale is ReentrancyGuard {
  ...
  constructor(address _presaleGenerator)  {
    ...
    WBNB = IWBNB(0xa6c3c0c397DE062Df60c080341b4900eeB27acb2);
  ...
  function userWithdrawBaseTokens () external nonReentrant {
    ...
    TransferHelper.safeTransferBaseToken(address(PRESALE_INFO.B_TOKEN), msg.sender, tokensOwed, !PRESALE_INFO.PRESALE_IN_BNB);
  }
  ...
  function addLiquidity() external nonReentrant {
    ...
    TransferHelper.safeTransferBaseToken(address(PRESALE_INFO.B_TOKEN), PRESALE_FEE_INFO.BASE_FEE_ADDRESS, unicryptBaseFee, !PRESALE_INFO.PRESALE_IN_BNB);
