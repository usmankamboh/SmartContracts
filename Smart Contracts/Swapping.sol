...
pragma solidity ^0.8.0;
        ...
        {           
         ...
         mapping(uint256=>IDO_data) tiers;  
        constructor()
        {
    tiers[0]= IDO_data({Upper_limit : 100 , Quantity :5000 ,Price :0.01 ether,Number_of_Tokens :50000000 });
    tiers[1]= IDO_data({Upper_limit: 500,   Quantity :2000   ,Price:0.02 ether,Number_of_Tokens :50000000});
    tiers[2]= IDO_data({Upper_limit : 1000, Quantity :2000 ,Price:0.03 ether,Number_of_Tokens :66666667});
        }  
