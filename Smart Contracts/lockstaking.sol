...
contract StakingDapp {
    ...
    function unstakeToken() public {
        ...
        if ( block.timestamp ==  releasetime + 7776000){
           Token.transferFrom(address(this),msg.sender, balance); //transfer back token to use
           rewardToken.transferFrom(address(this),(msg.sender), (20*1000000000000000000)/100 );
           _balances[msg.sender] = (20*1000000000000000000)/100;
        }else{
            if ( block.timestamp ==  releasetime + 5184000){
           Token.transferFrom(address(this),msg.sender, balance); //transfer back token to use
           rewardToken.transferFrom(address(this),(msg.sender), (15*1000000000000000000)/100 );
            _balances[msg.sender] = (15*1000000000000000000)/100;
        }else{
            if ( block.timestamp ==  releasetime + 2592000){
           Token.transferFrom(address(this),msg.sender, balance); //transfer back token to use
           rewardToken.transferFrom(address(this),(msg.sender), (10*1000000000000000000)/100 );
           _balances[msg.sender] = (20*1000000000000000000)/100;
        }
